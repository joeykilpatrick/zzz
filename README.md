...
1. [Download AutoHotkey v1.1](https://www.autohotkey.com/download/1.1/) (recommended).
2. Clone or download this repository:
```bash
git clone https://github.com/joeykilpatrick/zzz.git
cd zzz
```
3. Double-click `zzz.ahk` or run:
```bash
autohotkey zzz.ahk
```

### Alternative: Use the precompiled `.exe`
1. Go to [Releases](https://github.com/joeykilpatrick/zzz/releases).
2. Download `zzz.exe`.
